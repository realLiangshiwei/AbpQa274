...
namespace AbpQa274.ObjectExtending
{
    public static class AbpQa274DomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpQa274EfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
